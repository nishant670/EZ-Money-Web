...
export default function TransactionsScreen() {
    ...
    const exportCurrentView = async () => {
        ...
        try {
            ...
            link.href = url;
            link.download = `finnri-transactions-${isoDate(new Date())}.csv`;
